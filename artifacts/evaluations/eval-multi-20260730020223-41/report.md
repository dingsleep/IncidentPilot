# Evaluation eval-multi-20260730020223-41

Suite: `train-v2-score-v5`  
Candidate: `p1-9030b15a9d6b:qwen3.7-plus:json_output:q-2f310decbea1:t-telemetry-v9:s-v8-tax4`  
Mode: `multi`

| Score | Root cause | Evidence | Hard failures | Cost (micro-USD) | Duration (ms) |
|---:|---:|---:|---:|---:|---:|
| 0.662 | 0.250 | 1.000 | 0 | 25583 | 190019 |

## Failed Episodes

- [ad-failure-001](report.json#ad-failure-001) — 0.550; score below 1.0
